...
# for ours training
X_MIN = np.array([-5., -np.pi/3, -1., -1.]).reshape(-1,1)
X_MAX = np.array([ 5.,  np.pi/3,  1.,  1.]).reshape(-1,1)
...
XE_INIT_MIN = np.array([-0.3, -0.3, -0.3, -0.3])
XE_INIT_MAX = np.array([ 0.3,  0.3,  0.3,  0.3])
